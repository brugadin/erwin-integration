Friend Class frmAbout
    ...
    Private Sub frmAbout_Load(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles MyBase.Load
        ...
        lblVersion.Text = "Version 12.5 / Sample Application. No support provided"
        lblTitle.Text = My.Application.Info.Title

        Dim buildNumber = Mid(oApplication.Version, 9)
        lblDescription.Text = "erwin Data Modeler 12.5." & buildNumber & Chr(10) & "SCAPI Version 9.0 (12.5." & buildNumber & ")"
    End Sub
End Class